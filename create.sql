...
CREATE TABLE ENTRIES (ID INTEGER AUTO_INCREMENT NOT NULL, COMMENT VARCHAR(255), DATE DATETIME NOT NULL, IS_INCOME TINYINT(1) default 0, NAME VARCHAR(255) NOT NULL, VALUE DECIMAL(38) NOT NULL, CATEGORY_ID INTEGER NOT NULL, ITEM_ID INTEGER NOT NULL, PRIMARY KEY (ID))
