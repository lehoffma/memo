# CREATE TABLE ADDRESSES (ID INTEGER AUTO_INCREMENT NOT NULL, CITY VARCHAR(255), COUNTRY VARCHAR(255), LATITUDE DOUBLE, LONGITUDE DOUBLE, NAME VARCHAR(255), STREET VARCHAR(255), STREETNR VARCHAR(255), ZIP VARCHAR(255), ITEM_ID INTEGER, USER_ID INTEGER, PRIMARY KEY (ID))
