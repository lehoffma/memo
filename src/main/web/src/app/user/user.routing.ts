...
const routes: Route[] = [
...

	{
		...
		children: [
			{path: "", redirectTo: "personal-data", pathMatch: "full", canActivate: [AuthenticatedGuard]},
			{path: "personal-data", component: PersonalDataWrapperComponent, canActivate: [AuthenticatedGuard]},
			{path: "profile-picture", component: ProfilePictureWrapperComponent, canActivate: [AuthenticatedGuard]},
			{path: "addresses", component: AddressesWrapperComponent, canActivate: [AuthenticatedGuard]},
			{path: "account", component: AccountDataWrapperComponent, canActivate: [AuthenticatedGuard]},
			{path: "payment", component: PaymentSettingsComponent, canActivate: [AuthenticatedGuard]},
			{path: "club", component: ClubInformationWrapperComponent, canActivate: [AuthenticatedGuard]},
			{path: "notifications", component: NotificationSettingsComponent, canActivate: [AuthenticatedGuard]},
		],
