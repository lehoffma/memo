...
@Component({
	selector: 'object-details-overview',
	templateUrl: './object-details-overview.component.html',
	styleUrls: ['./object-details-overview.component.scss']
})
export class ObjectDetailsOverviewComponent implements OnInit {
